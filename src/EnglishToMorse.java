 ...
 * Description: Program that allows users to specify a file to read English from, convert to Morse Code, then write to the same file.
 */
 ...
 // Start of EnglishToMorse class, main class which converts plain english text to morse code
 public class EnglishToMorse {
	// Main method, entry point of program. All functionality is contained within here for this program
	 public static void main(String[] args) {
		 ...
		 // Assignment of file name value, with default of "src/English.txt"
		 ...
		 try {
			// Declarations
			 ...
			 JOptionPane.showMessageDialog(null, output, "Showing contents of " + fileName + " converted to Morse Code", JOptionPane.PLAIN_MESSAGE);
